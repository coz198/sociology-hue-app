                            ...
                            <View style={{flex:1}}>
                                <View style={{flex: 1, alignItems: 'center'}}>
                                    <FlatList
                                        ...
                                        ListHeaderComponent={
                                            <View style={[general.wrapperRowCenter, general.padding, general.marginBottomFar]}>
                                                <Image
                                                ...
                                                <View style={general.marginLR}>
                                                    ...
                                                    <Text style={general.textDescriptionCard}>Dữ liệu về cuộc khảo sát mà bạn đã thực hiện.</Text>
                                                </View>
                                            </View>
                                        }
                                        ...
                                        renderItem={({item}) =>
                                            <TouchableOpacity
                                                ...
                                                <Text style={[general.categoryInImage, general.textDescriptionCardLight, {right: 10}]}>
                                                    {item.created_at}
                                                </Text>
                                                <View style={general.wrapperSpace}/>
                                            </TouchableOpacity>
